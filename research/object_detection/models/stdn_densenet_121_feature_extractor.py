...
def scale_transfer_module_densent_121(image_features):
    return image_features


class STDNDenseNet121FeatureExtractor(stdn_meta_arch.STDNFeatureExtractor):
    ...
    def __init__(self,
        ...
        """
        super(STDNDenseNet121FeatureExtractor, self).__init__(
        ...
        with tf.control_dependencies([shape_assert]):
            with slim.arg_scope(self._conv_hyperparams):
                with tf.variable_scope('densenet121',
                    ...
                    image_features = scale_transfer_module_densent_121(image_features)
