...
_ARGMAXMATCHER = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='object_detection.protos.ArgMaxMatcher.negatives_lower_than_unmatched', index=3,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='force_match_for_each_row', full_name='object_detection.protos.ArgMaxMatcher.force_match_for_each_row',
            index=4,
