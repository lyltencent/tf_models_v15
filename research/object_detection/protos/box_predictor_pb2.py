...
_BOXPREDICTOR = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='object_detection.protos.BoxPredictor.convolutional_box_predictor', index=0,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='mask_rcnn_box_predictor', full_name='object_detection.protos.BoxPredictor.mask_rcnn_box_predictor',
            index=1,
...
_CONVOLUTIONALBOXPREDICTOR = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='conv_hyperparams', full_name='object_detection.protos.ConvolutionalBoxPredictor.conv_hyperparams',
            index=0,
            number=1, type=11, cpp_type=10, label=1,
            has_default_value=False, default_value=None,
            message_type=None, enum_type=None, containing_type=None,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='object_detection.protos.ConvolutionalBoxPredictor.num_layers_before_predictor', index=3,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='object_detection.protos.ConvolutionalBoxPredictor.dropout_keep_probability', index=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='object_detection.protos.ConvolutionalBoxPredictor.apply_sigmoid_to_scores', index=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='object_detection.protos.ConvolutionalBoxPredictor.class_prediction_bias_init', index=9,
...
_MASKRCNNBOXPREDICTOR = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='dropout_keep_probability',
            full_name='object_detection.protos.MaskRCNNBoxPredictor.dropout_keep_probability', index=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='object_detection.protos.MaskRCNNBoxPredictor.predict_instance_masks', index=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='object_detection.protos.MaskRCNNBoxPredictor.mask_prediction_conv_depth', index=6,
            number=7, type=5, cpp_type=1, label=1,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='predict_keypoints', full_name='object_detection.protos.MaskRCNNBoxPredictor.predict_keypoints',
            index=7,
...
_RFCNBOXPREDICTOR = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='object_detection.protos.RfcnBoxPredictor.num_spatial_bins_height', index=1,
            number=2, type=5, cpp_type=1, label=1,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='num_spatial_bins_width', full_name='object_detection.protos.RfcnBoxPredictor.num_spatial_bins_width',
            index=2,
            number=3, type=5, cpp_type=1, label=1,
            has_default_value=True, default_value=3,
            message_type=None, enum_type=None, containing_type=None,
...
_BOXPREDICTOR.fields_by_name['convolutional_box_predictor'].containing_oneof = _BOXPREDICTOR.oneofs_by_name[
    'box_predictor_oneof']
_BOXPREDICTOR.oneofs_by_name['box_predictor_oneof'].fields.append(
    _BOXPREDICTOR.fields_by_name['mask_rcnn_box_predictor'])
_BOXPREDICTOR.fields_by_name['mask_rcnn_box_predictor'].containing_oneof = _BOXPREDICTOR.oneofs_by_name[
    'box_predictor_oneof']
_BOXPREDICTOR.oneofs_by_name['box_predictor_oneof'].fields.append(
    _BOXPREDICTOR.fields_by_name['rfcn_box_predictor'])
_BOXPREDICTOR.fields_by_name['rfcn_box_predictor'].containing_oneof = _BOXPREDICTOR.oneofs_by_name[
    'box_predictor_oneof']
...
_MASKRCNNBOXPREDICTOR.fields_by_name[
    'fc_hyperparams'].message_type = object__detection_dot_protos_dot_hyperparams__pb2._HYPERPARAMS
_MASKRCNNBOXPREDICTOR.fields_by_name[
    'conv_hyperparams'].message_type = object__detection_dot_protos_dot_hyperparams__pb2._HYPERPARAMS
