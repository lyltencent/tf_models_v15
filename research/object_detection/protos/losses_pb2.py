...
_WEIGHTEDL2LOCALIZATIONLOSS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='anchorwise_output', full_name='object_detection.protos.WeightedL2LocalizationLoss.anchorwise_output',
            index=0,
...
_WEIGHTEDSMOOTHL1LOCALIZATIONLOSS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='object_detection.protos.WeightedSmoothL1LocalizationLoss.anchorwise_output', index=0,
            number=1, type=8, cpp_type=7, label=1,
            has_default_value=True, default_value=False,
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
...
_CLASSIFICATIONLOSS = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='bootstrapped_sigmoid', full_name='object_detection.protos.ClassificationLoss.bootstrapped_sigmoid',
            index=2,
            number=3, type=11, cpp_type=10, label=1,
            has_default_value=False, default_value=None,
            message_type=None, enum_type=None, containing_type=None,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='object_detection.protos.ClassificationLoss.weighted_sigmoid_focal', index=3,
...
_WEIGHTEDSIGMOIDCLASSIFICATIONLOSS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='anchorwise_output',
            full_name='object_detection.protos.WeightedSigmoidClassificationLoss.anchorwise_output', index=0,
            number=1, type=8, cpp_type=7, label=1,
            has_default_value=True, default_value=False,
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
...
_SIGMOIDFOCALCLASSIFICATIONLOSS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='anchorwise_output',
            full_name='object_detection.protos.SigmoidFocalClassificationLoss.anchorwise_output', index=0,
            number=1, type=8, cpp_type=7, label=1,
            has_default_value=True, default_value=False,
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
...
_WEIGHTEDSOFTMAXCLASSIFICATIONLOSS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='anchorwise_output',
            full_name='object_detection.protos.WeightedSoftmaxClassificationLoss.anchorwise_output', index=0,
            number=1, type=8, cpp_type=7, label=1,
            has_default_value=True, default_value=False,
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
            options=None),
        _descriptor.FieldDescriptor(
            name='logit_scale', full_name='object_detection.protos.WeightedSoftmaxClassificationLoss.logit_scale',
            index=1,
            number=2, type=2, cpp_type=6, label=1,
            has_default_value=True, default_value=float(1),
            message_type=None, enum_type=None, containing_type=None,
...
_BOOTSTRAPPEDSIGMOIDCLASSIFICATIONLOSS = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='hard_bootstrap',
            full_name='object_detection.protos.BootstrappedSigmoidClassificationLoss.hard_bootstrap', index=1,
        ...
        _descriptor.FieldDescriptor(
            name='anchorwise_output',
            full_name='object_detection.protos.BootstrappedSigmoidClassificationLoss.anchorwise_output', index=2,
...
_HARDEXAMPLEMINER = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='object_detection.protos.HardExampleMiner.max_negatives_per_positive', index=3,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='object_detection.protos.HardExampleMiner.min_negatives_per_image', index=4,
...
_LOCALIZATIONLOSS.fields_by_name['weighted_smooth_l1'].containing_oneof = _LOCALIZATIONLOSS.oneofs_by_name[
    'localization_loss']
_LOCALIZATIONLOSS.oneofs_by_name['localization_loss'].fields.append(
    _LOCALIZATIONLOSS.fields_by_name['weighted_iou'])
_LOCALIZATIONLOSS.fields_by_name['weighted_iou'].containing_oneof = _LOCALIZATIONLOSS.oneofs_by_name[
    'localization_loss']
...
_CLASSIFICATIONLOSS.fields_by_name['weighted_sigmoid'].containing_oneof = _CLASSIFICATIONLOSS.oneofs_by_name[
    'classification_loss']
_CLASSIFICATIONLOSS.oneofs_by_name['classification_loss'].fields.append(
    _CLASSIFICATIONLOSS.fields_by_name['weighted_softmax'])
_CLASSIFICATIONLOSS.fields_by_name['weighted_softmax'].containing_oneof = _CLASSIFICATIONLOSS.oneofs_by_name[
    'classification_loss']
_CLASSIFICATIONLOSS.oneofs_by_name['classification_loss'].fields.append(
    _CLASSIFICATIONLOSS.fields_by_name['bootstrapped_sigmoid'])
_CLASSIFICATIONLOSS.fields_by_name['bootstrapped_sigmoid'].containing_oneof = _CLASSIFICATIONLOSS.oneofs_by_name[
    'classification_loss']
_CLASSIFICATIONLOSS.oneofs_by_name['classification_loss'].fields.append(
    _CLASSIFICATIONLOSS.fields_by_name['weighted_sigmoid_focal'])
_CLASSIFICATIONLOSS.fields_by_name['weighted_sigmoid_focal'].containing_oneof = _CLASSIFICATIONLOSS.oneofs_by_name[
    'classification_loss']
...
WeightedSmoothL1LocalizationLoss = _reflection.GeneratedProtocolMessageType('WeightedSmoothL1LocalizationLoss',
...
WeightedIOULocalizationLoss = _reflection.GeneratedProtocolMessageType('WeightedIOULocalizationLoss',
                                                                       (_message.Message,), dict(
...
WeightedSigmoidClassificationLoss = _reflection.GeneratedProtocolMessageType('WeightedSigmoidClassificationLoss',
                                                                             (_message.Message,), dict(
...
SigmoidFocalClassificationLoss = _reflection.GeneratedProtocolMessageType('SigmoidFocalClassificationLoss',
                                                                          (_message.Message,), dict(
...
WeightedSoftmaxClassificationLoss = _reflection.GeneratedProtocolMessageType('WeightedSoftmaxClassificationLoss',
                                                                             (_message.Message,), dict(
...
BootstrappedSigmoidClassificationLoss = _reflection.GeneratedProtocolMessageType(
    'BootstrappedSigmoidClassificationLoss', (_message.Message,), dict(
