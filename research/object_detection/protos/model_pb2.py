...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    ,
    dependencies=[object__detection_dot_protos_dot_faster__rcnn__pb2.DESCRIPTOR,
...
_DETECTIONMODEL.fields_by_name[
    'faster_rcnn'].message_type = object__detection_dot_protos_dot_faster__rcnn__pb2._FASTERRCNN
