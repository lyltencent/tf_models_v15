...
_REGIONSIMILARITYCALCULATOR = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='object_detection.protos.RegionSimilarityCalculator.neg_sq_dist_similarity', index=0,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='iou_similarity', full_name='object_detection.protos.RegionSimilarityCalculator.iou_similarity',
            index=1,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='ioa_similarity', full_name='object_detection.protos.RegionSimilarityCalculator.ioa_similarity',
            index=2,
...
_REGIONSIMILARITYCALCULATOR.fields_by_name['neg_sq_dist_similarity'].containing_oneof = \
_REGIONSIMILARITYCALCULATOR.oneofs_by_name['region_similarity']
_REGIONSIMILARITYCALCULATOR.oneofs_by_name['region_similarity'].fields.append(
    _REGIONSIMILARITYCALCULATOR.fields_by_name['iou_similarity'])
_REGIONSIMILARITYCALCULATOR.fields_by_name['iou_similarity'].containing_oneof = \
_REGIONSIMILARITYCALCULATOR.oneofs_by_name['region_similarity']
_REGIONSIMILARITYCALCULATOR.oneofs_by_name['region_similarity'].fields.append(
    _REGIONSIMILARITYCALCULATOR.fields_by_name['ioa_similarity'])
_REGIONSIMILARITYCALCULATOR.fields_by_name['ioa_similarity'].containing_oneof = \
_REGIONSIMILARITYCALCULATOR.oneofs_by_name['region_similarity']
