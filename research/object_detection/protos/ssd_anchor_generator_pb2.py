...
_SSDANCHORGENERATOR = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='object_detection.protos.SsdAnchorGenerator.interpolated_scale_aspect_ratio', index=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='object_detection.protos.SsdAnchorGenerator.reduce_boxes_in_lowest_layer', index=6,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='base_anchor_height', full_name='object_detection.protos.SsdAnchorGenerator.base_anchor_height',
            index=7,
